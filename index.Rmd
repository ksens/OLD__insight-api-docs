...
The Insight API ([https://github.com/paradigm4/insight](https://github.com/paradigm4/insight)) leverages the multidimensional array database [SciDB](https://www.paradigm4.com/) to handle:
